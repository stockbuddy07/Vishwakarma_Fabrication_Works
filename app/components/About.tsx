      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            ...
            <button 
              onClick={openMap}
              className="w-full text-left p-6 rounded-2xl text-white bg-gradient-to-r from-orange-600 to-blue-600 flex gap-4 items-center shadow-xl hover:scale-[1.02] transition-transform cursor-pointer group"
            >
          ...
          <div className="max-w-7xl mx-auto p-4">
            ...
            <div className="flex justify-between items-end mb-6 px-2">
              <h2 className={`text-4xl font-black tracking-tight ${darkMode ? 'text-white' : 'text-gray-900'}`}>Gallery</h2>
            </div>
            ...
            <div className="grid grid-cols-3 grid-rows-2 gap-4 h-[450px]">
              ...
              <div className="col-span-2 row-span-1 rounded-3xl rounded-tl-[60px] bg-black overflow-hidden relative shadow-xl">
                <iframe 
                  ...
                  src="https://www.youtube.com/embed/zqmDORs-jC0?autoplay=1&mute=1&loop=1&playlist=zqmDORs-jC0" 
